...
export const createAnOrder = createAsyncThunk(
  ...
  async ({ orderDetail, token }, thunkAPI) => {
    try {
      return await authService.createOrder(orderDetail, token);
    } catch (error) {
      return thunkAPI.rejectWithValue(error);
    }
  }
    ...
    builder
      ...
      .addCase(registerUser.fulfilled, (state, action) => {
        ...
        if (state.isSuccess === true) {
          toast.info("Tài khoản người dùng được tạo thành công");
        }
      })
      ...
      .addCase(forgotPasswordToken.fulfilled, (state, action) => {
        ...
        if (state.isSuccess) {
          toast.success("Đã gửi email quên mật khẩu!");
        }
      })
